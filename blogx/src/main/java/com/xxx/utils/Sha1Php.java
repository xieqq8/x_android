...
/**
 * SHA加密
 * Created by xieqq on 2016-03-29 .
 */
public class Sha1Php {
    ...
    private void encrypt() {
        ...
        for (int k = 20; k <= 39; k++) {
            int tmp = f4(tmpabcde[0], 5) +
                    f2(tmpabcde[1], tmpabcde[2], tmpabcde[3]) + tmpabcde[4] + tmpData[k] + 0x6ed9eba1;
            tmpabcde[4] = tmpabcde[3];
            tmpabcde[3] = tmpabcde[2];
            tmpabcde[2] = f4(tmpabcde[1], 30);
            tmpabcde[1] = tmpabcde[0];
...
//    }
    ...
    public String GetPHPDigestofString(byte[] byteData){


        return byte2HexStr(getDigestOfBytes(byteData));
    }
